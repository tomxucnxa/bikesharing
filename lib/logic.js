...
async function processBikeReleaseTransaction(tx) {
    ...
    await processGeneralBikeTransaction(tx);
}
...
/**
 * 
 * @param {org.bikesharing.biznet.BikeTransaction} tx 
 */
async function processGeneralBikeTransaction(tx) {
    ...
    await assetRegistry.update(tx.bike);
}
